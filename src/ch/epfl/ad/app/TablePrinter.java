...
public class TablePrinter {
	...
	public static void printTable(DatabaseManager dbManager, String tableName, String nodeId) throws SQLException, InterruptedException {
		
		System.out.println("");
		ResultSet result = dbManager.fetch("SELECT * FROM " + tableName, nodeId);
		TableStreamer.printViewData(System.in, System.out, result);
		
	}
	

	private static class TableStreamer {
		
		public static void printViewData(InputStream is, OutputStream os, ResultSet result) throws SQLException, InterruptedException {
